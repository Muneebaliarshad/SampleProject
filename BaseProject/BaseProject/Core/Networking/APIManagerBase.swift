...
class APIManagerBase: NSObject{
    ...
    func serverRequestForNumber(route: URL,
        ...
        alamoFireManager.request(route, method: requestType, parameters: nil, encoding: JSONEncoding.default, headers: getAuthorizationHeader()).responseJSON{
            response in
    ...
    func serverRequestWith(route: URL,
        ...
        alamoFireManager.request(route, method: requestType, parameters: parameters, encoding: JSONEncoding.default, headers: getAuthorizationHeader()).responseJSON{
            response in
            guard response.error == nil else{
